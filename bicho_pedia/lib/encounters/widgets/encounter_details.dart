...
class EncounterDetailsWidget extends StatefulWidget {
  ...
  const EncounterDetailsWidget({Key? key, required this.encounter})
      : super(key: key);
...
class _EncounterDetailsWidgetState extends State<EncounterDetailsWidget> {
  late Widget _infoContainer;
  late Widget _galleryContainer;
  late Widget _locationContainer;
  late Widget _currentContainer;

  @override
  void initState() {
    super.initState();
    _currentContainer = _buildInfoContainer();
  }
  ...
  @override
  Widget build(BuildContext context) {
    _infoContainer = _buildInfoContainer();
    _galleryContainer = _buildGalleryContainer();
    _locationContainer = _buildLocationContainer();
                    ...
                    child: Row(
                      ...
                      children: [
                        TextButton(
                          onPressed: () {
                            setState(() {
                              _currentContainer = _infoContainer;
                            });
                          },
                          child: const Text(
                            'Info',
                        ...
                        TextButton(
                          onPressed: () {
                            setState(() {
                              _currentContainer = _galleryContainer;
                            });
                          },
                          child: const Text(
                            'Gallery',
                        ...
                        TextButton(
                          onPressed: () {
                            setState(() {
                              _currentContainer = _locationContainer;
                            });
                          },
                          child: const Text(
                            'Location',
